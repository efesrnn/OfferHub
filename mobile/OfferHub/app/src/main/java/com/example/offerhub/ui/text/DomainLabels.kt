...
@Composable fun adminCodeLabel(code: String): String = when (code) {
    ...
    "RISKLI_KAYIP" -> stringResource(R.string.admin_specialty_churn_risk)
    "YUKSEK_DEGER" -> stringResource(R.string.admin_specialty_high_value)
    "YENI_ABONE" -> stringResource(R.string.admin_specialty_new_subscriber)
    "PASIF" -> stringResource(R.string.admin_specialty_inactive)
